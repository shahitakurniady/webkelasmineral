<?php
	...
	$wfsUrl = file_get_contents("http://localhost:8080/geoserver/kelasmineral/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=kelasmineral%3APG_kalsit&outputFormat=application%2Fjson");
